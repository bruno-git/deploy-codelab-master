...
["", "piratebadge.dart", , A, {
  ...
  main: [function() {
    ...
    inputField.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(inputField, C.EventStreamProvider_input._eventType, false), [null]);
  ...
  }, "call$1", "updateBadge$closure", 2, 0, 8],
  generateBadge: [function(e) {
    A.setBadgeName(A.PirateName$(null, null));
  }, "call$1", "generateBadge$closure", 2, 0, 8],
  ...
  PirateName: {
    ...
    PirateName$2$appellation$firstName: function(appellation, firstName) {
      ...
      if (firstName == null) {
        ...
        t1 = J.$index$asx(t1, $.get$PirateName_indexGen().nextInt$1(J.get$length$asx(t1)));
      } else
        t1 = firstName;
      this._firstName = t1;
      t1 = $.get$PirateName_appellations();
      t1 = J.$index$asx(t1, $.get$PirateName_indexGen().nextInt$1(J.get$length$asx(t1)));
      this._appellation = t1;
    },
    ...
    static: {"": "PirateName_indexGen,PirateName_names,PirateName_appellations", PirateName$: function(appellation, firstName) {
      ...
      }, "call$1", "PirateName__parsePirateNamesFromJSON$closure", 2, 0, 9]}
  }
},
1],
]);
